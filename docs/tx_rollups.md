...
TORU currently supports the transferring of funds in the form of [tickets](https://taquito.mavryk.org/docs/tickets). Fund (or ticket) transfers can be done from:
