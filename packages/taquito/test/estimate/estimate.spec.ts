...
<<<<<<< HEAD
    expect(estimate.minimalFeeMumav).toStrictEqual(3686);
    expect(estimate.suggestedFeeMumav).toStrictEqual(3786);
...
<<<<<<< HEAD
    expect(estimate.minimalFeeMumav).toStrictEqual(2022);
    expect(estimate.suggestedFeeMumav).toStrictEqual(2122);
    expect(estimate.usingBaseFeeMumav).toStrictEqual(11922);
