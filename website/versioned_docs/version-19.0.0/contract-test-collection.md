...
bigMapLedger.set('mv19hrERfz4Drj6TXg79DF1ZXZDPwq5igZW7', {
  allowances: ['mv1W9WUWpdHfgSYwV9hksndfxJYGAQqhLZra'],
  balance: '50',
});
...
```js
Pair 10 (Pair 20 (Pair "Hello" (Pair 0xffff (Pair 100 (Pair False (Pair "mv1JQ19UKK5w264P8SDJmwjHsrXZASegkXrH" (Pair 1570374509 "mv1JQ19UKK5w264P8SDJmwjHsrXZASegkXrH")))))))
```
