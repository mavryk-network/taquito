...
Running `npx ts-node index.ts` should now show the balance of the specified address. This balance is in units of Mumav (micro Tez). Mav is the currency of Tezos, its code is `MVRK`, and the symbol is `ṁ`. 1 Mav is 1,000,000 Mumav.
